  ...
  <div class="container feedback">
    ...
    <div class="feedback-item">
      ...
      <div class="add-date-piker">
        <el-date-picker v-model="orderInfo.purchasetime" type="datetime" size="mini" placeholder="选择日期时间"></el-date-picker>
      </div>
    </div>
    <div class="feedback-item">
      <span class="info-hint">收货地址</span>
      <div :class="addressStatus?'feedback-item-list-active':'feedback-item-list'">
        <input
          v-model="orderInfo.detailaddress"
          type="text"
          style="none"
          class="feedback-item-file"
          placeholder="收货地址"
    ...
    <div class="feedback-item">
      <span class="info-hint">购买状态</span>
      <div :class="purchaGoodsStatus?'feedback-item-list-active':'feedback-item-list'">
        <input
          v-model="orderInfo.goodsstatus"
          type="text"
          style="none"
          class="feedback-item-file"
          placeholder="购买状态"
          @focus="handleFocusBorderStyle($event,'purchaGoods')"
          @blur="handleBlurBorderStyle($event,'purchaGoods')"
        />
      </div> 
    </div>
    <!-- <div class="feedback-item">
  ...
  methods: {
    handleFocusBorderStyle(e, data) {
      ...
      if (data === "password") this.passwordStatus = true;
        if (data === "purchaGoods") this.purchaGoodsStatus = true;
    },
    handleBlurBorderStyle(e, data) {
      ...
      if (data === "password") this.passwordStatus = false;
       if (data === "purchaGoods") this.purchaGoodsStatus = false;
    }
  }
};
</script>
